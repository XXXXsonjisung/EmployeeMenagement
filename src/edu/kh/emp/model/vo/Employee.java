...
public class Employee {
	...
	public Employee(int empId, String empName, String empNo, String email, String phone, String departmentTitle,
			String jobName, int salary, String deptCode, String jobCode, String salLevel) {
		super();
		this.empId = empId;
		this.empName = empName;
		this.empNo = empNo;
	...
	public Employee(int empId, String email, String phone, int salary) {
		super();
		this.empId = empId;
		this.email = email;
		this.phone = phone;
